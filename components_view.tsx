...
import { 
  analyzeLandmark, generateRecoveryPlan, findNearestPoliceStations, performCarrierTriangulation, getNearestStation, detectTheftAnomaly
} from './services';
import { 
      ...
      <div className="w-full lg:w-[400px] bg-slate-900/80 backdrop-blur-3xl border-l border-white/5 p-8 space-y-8 overflow-y-auto custom-scrollbar flex flex-col">
         ...
         <div className="space-y-4 flex-1">
            ...
            <div className="space-y-3">
               {selected.agent?.scrapedContacts?.map((contact: any, i: number) => (
